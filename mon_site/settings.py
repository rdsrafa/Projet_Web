...
SECRET_KEY = 'django-insecure-e$qg+&q-cn%49ep2d5rzo)gu$ckqf-3!zz5j&%^kyc)=u6c%7b'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Laissez vide, les templates sont dans l'app
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'tutorat.context_processors.notifications',
            ],
        },
    },
]
